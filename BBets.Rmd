...
I am trying to show the odds of winning in students and showing the best odds of 2:1 ratio for students and teacher.
...
print(paste('Average win/loss per class:',round(bet1,2)))
```
The average winning per class is around $8
